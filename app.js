...
async function calculateSafeRoute() {
  ...
  if (!floodDataGlobal) {
    alert("طبقة الخطورة (flood) لم تُحمّل بعد. انتظر ثواني وحاول.");
    return;
  }
  ...
  try {
    // 1) جرّب أولاً مسار آمن (يتجنب مناطق gridcode 4-5)
    ...
    try {
      ...
      showStatus("❌ فشل حساب المسار. تأكد من مفتاح ORS أو الإنترنت.");
      alert("فشل حساب المسار. افتح Console وانظر الخطأ (F12).");
    }
  }
}
